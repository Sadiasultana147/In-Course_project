...
namespace Work02
{
    public class ChatHub : Hub
    {
        ...
        public static readonly List<string> groups = new List<string> { "C# Programmers", "R43 Trainees", "NET Core Developers" };
        public override Task OnConnected()
        {
            Clients.All.message("SERVER", "new guest connected");
